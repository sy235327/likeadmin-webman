...
export function smsLists() {
    return request.get({ url: "/notice/smsConfig/getConfig" })
}

// 短信设置详情
export function smsDetail(params: any) {
    return request.get({ url: "/notice/smsConfig/detail", params })
}

// 短信设置保存
export function setSmsConfig(params: any) {
    return request.post({ url: "/notice/smsConfig/setConfig", params })
}
