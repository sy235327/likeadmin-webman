    ...
    <div class="code-generation">
        ...
        <el-card class="!border-none mt-4" shadow="never" v-loading="pager.loading">
            <div class="flex">
                ...
                <el-button v-perms="['tools.generator/generate']" :disabled="!selectData.length" @click="handleGenerate(selectData)"> 生成代码 </el-button>
            </div>
            <div class="mt-4">
                    ...
                    <el-table-column label="操作" width="160" fixed="right">
                        <template #default="{ row }">
                            <div class="flex items-center">
                                <el-button v-perms="['tools.generator/preview']" type="primary" link @click="handlePreview(row.id)"> 预览 </el-button>
                                ...
                                <el-dropdown
                                    ...
                                    v-perms="['tools.generator/generate', 'tools.generator/syncColumn', 'tools.generator/delete']"
                                >
                                    <el-button type="primary" link>
                                        更多
...
import { generateTable, syncColumn, generateDelete, generatePreview, generateCode } from "@/api/tools/code"
